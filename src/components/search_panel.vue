<template lang="html">
    <v-container>
        <v-menu :close-on-content-click="false" open-on-focus autofocus offset-y bottom>
            <template v-slot:activator="{ on }">
                ...
                <v-spacer class="d-flex justify-end">
                    <v-btn v-if="is_filtered" color="secondary" rounded small @click="set_default()"> clear all </v-btn>
                    <v-switch
                        inset
                        dese
                        hide-details
            ...
            <v-card :width="$vuetify.breakpoint.mdAndUp ? '33vw' : '100vw'">
                <v-card-text>
                    ...
                    <v-divider></v-divider>
                    <v-chip-group active-class="primary--text" v-model="selected_day_of_week" column multiple>
                        <v-chip
                    ...
                    <v-row class="mx-0 mt-0">
                        ...
                        <v-range-slider min="0" max="1440" step="30" ticks v-model="selected_time_range">
                        </v-range-slider>
                        <v-chip>
